   ...
   <div className='w-screen p-4'>
    ...
    <div className='min-h-min w-full p-10 mt-40 hero-1'>
       ...
       <div className=' w-full h-1/2 flex mt-2 flex-col gap-8'>
         ...
         <div className=' flex  pt-5   items-center justify-center gap-24 hero-3'>  
      ...
      <div className='flex items-center justify-center gap-24 hero-3'>  
          <div className=' w-24  flex flex-col items-center'>
        ...
        <div className='w-2/5 p-8 flex items-center flex-col gap-6 hero-2'>
